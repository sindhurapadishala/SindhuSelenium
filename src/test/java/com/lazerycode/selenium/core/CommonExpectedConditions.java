...
public class CommonExpectedConditions {
        ...
        return new ExpectedCondition<Boolean>() {
            public Boolean apply(WebDriver driver) {
                try {
                    ...
                    //System.out.println("Element visibility : "+isDisplayed);
                    driver.manage().timeouts().implicitlyWait(15, TimeUnit.SECONDS);
                    //System.out.println("Waited 15 seconds , Element visibility : "+isDisplayed);
                    return !isDisplayed;
                } catch (StaleElementReferenceException e) {
    ...
    public static ExpectedCondition<Boolean> visibilityOfElementLocated(final WebElement element) {
        return new ExpectedCondition<Boolean>() {
            public Boolean apply(WebDriver driver) {
                try {
                    driver.manage().timeouts().implicitlyWait(0, TimeUnit.SECONDS);
                    ...
                    System.out.println("Element visibility : "+isDisplayed);
                    if(!isDisplayed) {
                        System.out.println("Applying Implicit wait : "+isDisplayed);
                        driver.manage().timeouts().implicitlyWait(15, TimeUnit.SECONDS);
                        //System.out.println("Waited 15 seconds , Element visibility : "+isDisplayed);
                    }
                    return isDisplayed;
            ...
            @Override
            public String toString() {
                return "element to be visible: " + element.toString();
            }
        };
    }
